...
@SourceType(value = "USPSARP", label = "USPS",uiConfig = "usps-layout.json")
public class USPSConf extends AbstractArpConf<USPSConf> {
  private static final String ARP_FILENAME = "arp/implementation/usps-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.usps.USPSDriver";
